...
##create brand+car  model 
def build_initial_brand_model_model(epochs,data_dir='sorted-dataset',resolution=180,batch_size=32):
######################SETUP###############################
  ...
  model_name = 'initial_model_brand_classifier_epoch_'+str(epochs)
  ...
  os.makedirs("model-brand-model/model-data", exist_ok=True)
  os.makedirs("model-brand-model/plot", exist_ok=True)
  plt.savefig('model-brand-model/plot/'+model_name+'_'+str(epochs)+'.png')

  ######################SAVE MODEL#########################
  os.makedirs("model-brand-model/model", exist_ok=True)
  model.save('model-brand-model/model/'+model_name+'.h5')
  ...
  with open('model-brand-model/model-data/'+model_name+'.csv', 'w') as f:
...
##create brand+car  model with dropout
def build_dropout_brand_model_model(epochs,data_dir='sorted-dataset', dropout_rate_1=0.5, dropout_rate_2=0.5, dropout_rate_3=0.5,resolution=180,batch_size=32):
######################SETUP###############################
  ...
  model_name = 'dropout_brand_model_car_classifier_'+str(dropout_rate_1)+'_'+str(dropout_rate_2)+'_'+str(dropout_rate_3)+'_epoch_'+str(epochs)
  plt.figure(figsize=(8, 8))
  plt.subplot(1, 2, 1)
  plt.plot(epochs_range, acc, label='Training Accuracy')
  plt.plot(epochs_range, val_acc, label='Validation Accuracy')
  ...
  os.makedirs("model-brand-model/model-data", exist_ok=True)
  os.makedirs("model-brand-model/plot", exist_ok=True)
  plt.savefig('model-brand-model/plot/'+model_name+'.png')
...
##create brand+car  model with data augmentation
def build_data_augmented_brand_model_model(epochs,data_dir='sorted-dataset', dropout_rate_1=0.5, dropout_rate_2=0.5, dropout_rate_3=0.5,resolution=180,batch_size=32):
######################SETUP###############################
  ...
  model_name = 'brand_model_car_classifier_with_data_augmenation_'+str(dropout_rate_1)+'_'+str(dropout_rate_2)+'_'+str(dropout_rate_3)+'_epoch_'+str(epochs)
  plt.figure(figsize=(8, 8))
  plt.subplot(1, 2, 1)
  plt.plot(epochs_range, acc, label='Training Accuracy')
  plt.plot(epochs_range, val_acc, label='Validation Accuracy')
