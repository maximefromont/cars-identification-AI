...
destination_folder = "car-dataset"

# Create the destination folder if it doesn't exist
if not os.path.exists(destination_folder):
    os.makedirs(destination_folder)

def process_file(filename,brands,car):
...
def sort_dataset_into_car(brands,car):
    ...
    process_file_with_brands = partial(process_file, brands=brands,car=car)
